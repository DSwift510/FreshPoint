...
fvtProduct=''
ind=0
dbconnect = mysql.connector.connect(host='127.0.0.1',port='3306',database='ufoods',user='django',password='aggieprid3')
...
def setHeatmap(cursor):
  ...
  #  plt.xticks(fontsize=10, rotation=90)
    ...
    plt.savefig("""/Users/Dasani/Desktop/f_p_heatmap_slant.png""", dpi = 250)
    plt.tight_layout()
    plt.show()     
